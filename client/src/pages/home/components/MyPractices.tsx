...
export default function MyPractices(){
    ...
    <section>
        ...
        <div className="containerHabits" style={{display:'flex', width:'1442px', marginTop: '56px'}}>
            ...
            <div className="containerText" 
                style={{
                    ...
                    <Typography variant="h3" color={'text.secondary'} sx={{fontSize:"36px", lineHeight: "40px"}}>
                        ...
                        <Typography variant="body1" color={'text.primary'}
                         sx={{ marginTop:"30px", fontSize:"24px", lineHeight: "32px"}}>
                            ...
                            adecuado de ellas. Segundo, se puede conseguir un cuerpo saludable y una mente serena.
                        </Typography>
            </div>
            ...
            <img src="https://res.cloudinary.com/dlxlitkl6/image/upload/v1668435967/ananda%20marga/home/my_practices_nsp7fc.jpg" alt="Sesión de yoga" 
                className="imageMyPractices" style={{width:'554px', height:'334px', marginRight: '40px'}}/>
        </div>
        </Box>
