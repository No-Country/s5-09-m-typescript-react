const getContactTemplate = (fullName: string, email: string, text: string) => {
    return `  <head>
    <!-- NAME: SELL PRODUCTS -->
    <!--[if gte mso 15]>
    <xml>
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                <tbody><tr>
                    ...
                    <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                        ...
                        <span style="color:#279F87"><span style="font-size:18px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">Hola MindFulness!,<br>
Tienes el siguiente&nbsp; mensaje de: '${fullName}':</span></span></span><br>
<br>
<span style="color:#000000">&nbsp; &nbsp;${text}</span><br>
<br>
<span style="color:#279F87"><span style="font-size:18px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">Quedo a la espera de una respuesta ,<br>
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                <tbody><tr>
                    ...
                    <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                        ...
                        Copyright 2022 . All Rights reserved By Mindfulness
                    </td>
                </tr>
            </tbody></table>
            <!--[if mso]>
